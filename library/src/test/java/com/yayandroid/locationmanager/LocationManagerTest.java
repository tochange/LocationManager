...
public class LocationManagerTest {
    ...
    @Test public void callingOnPauseShouldRedirectToLocationProvider() {
        LocationManager locationManager = buildLocationManager();
    ...
    @Test public void callingOnResumeShouldRedirectToLocationProvider() {
        LocationManager locationManager = buildLocationManager();
    ...
    @Test public void callingOnDestroyShouldRedirectToLocationProvider() {
        LocationManager locationManager = buildLocationManager();
    ...
    @Test public void callingCancelShouldRedirectToLocationProvider() {
        LocationManager locationManager = buildLocationManager();
    ...
    @Test public void callingOnActivityResultShouldRedirectToLocationProvider() {
        LocationManager locationManager = buildLocationManager();
        int requestCode = 1;
        int resultCode = 2;
    ...
    @Test public void callingOnRequestPermissionsResultShouldRedirectToPermissionProvider() {
        LocationManager locationManager = buildLocationManager();
        int requestCode = 1;
    ...
    @Test public void callingGetShouldStartsPermissionRequest() {
        LocationManager locationManager = buildLocationManager();
    ...
    @Test public void askingForPermissionShouldNotifyListenerWithProcessTypeChanged() {
        LocationManager locationManager = buildLocationManager();
    ...
    @Test public void callingGetShouldRedirectToLocationProviderWhenPermissionIsGranted() {
        when(permissionProvider.hasPermission()).thenReturn(true);
        LocationManager locationManager = buildLocationManager();
